...
mod ohos {
  ...
  generate!(
    extern "C" {
      ...
      fn napi_load_module(env: napi_env,path: *const c_char,result: *mut napi_value) -> napi_status;
      // can be used in new ark runtime
      fn napi_load_module_with_info(env: napi_env,path: *const c_char,module_info: *const c_char,result: *mut napi_value) -> napi_status;
