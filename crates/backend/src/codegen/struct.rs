...
impl NapiStruct {
  ...
  fn gen_to_napi_value_ctor_impl_for_non_default_constructor_struct(
    ...
    let (object_finalize_impl, to_napi_value_impl, javascript_class_ext_impl) = if self.has_lifetime
    {
      ...
      (
        quote! { impl <'_javascript_function_scope> napi_ohos::bindgen_prelude::ObjectFinalize for #name {} },
        quote! { impl <'_javascript_function_scope> napi_ohos::bindgen_prelude::ToNapiValue for #name },
        quote! { impl <'_javascript_function_scope> napi_ohos::bindgen_prelude::JavaScriptClassExt for #name },
      )
    } else {
      (
        quote! { impl napi_ohos::bindgen_prelude::ObjectFinalize for #name {} },
        quote! { impl napi_ohos::bindgen_prelude::ToNapiValue for #name },
        quote! { impl napi_ohos::bindgen_prelude::JavaScriptClassExt for #name },
      )
    };
    ...
    quote! {
      ...
      #to_napi_value_impl {
        unsafe fn to_napi_value(
          ...
          if let Some(ctor_ref) = napi_ohos::__private::get_class_constructor(#js_name_str) {
            ...
            let instance_value = napi_ohos::bindgen_prelude::new_instance::<#name>(env, wrapped_value.cast(), ctor_ref)?;
      ...
      #javascript_class_ext_impl {
        fn into_instance<'scope>(self, env: &'scope napi_ohos::Env) -> napi_ohos::Result<napi_ohos::bindgen_prelude::ClassInstance<'scope, Self>>
         {
          if let Some(ctor_ref) = napi_ohos::bindgen_prelude::get_class_constructor(#js_name_str) {
            unsafe {
              let wrapped_value = Box::into_raw(Box::new(self));
              let instance_value = napi_ohos::bindgen_prelude::new_instance::<#name>(env.raw(), wrapped_value as *mut _ as *mut std::ffi::c_void, ctor_ref)?;
              Ok(napi_ohos::bindgen_prelude::ClassInstance::new(instance_value, env.raw(), wrapped_value))
            }
          } else {
            Err(napi_ohos::bindgen_prelude::Error::new(
        ...
        fn into_reference(self, env: napi_ohos::Env) -> napi_ohos::Result<napi_ohos::bindgen_prelude::Reference<Self>> {
          if let Some(ctor_ref) = napi_ohos::bindgen_prelude::get_class_constructor(#js_name_str) {
            unsafe {
              ...
              let instance_value = napi_ohos::bindgen_prelude::new_instance::<#name>(env.raw(), wrapped_value.cast(), ctor_ref)?;
              {
                let env = env.raw();
                #iterator_implementation
                #async_iterator_implementation
        ...
        fn instance_of<'env, V: napi_ohos::JsValue<'env>>(env: &napi_ohos::bindgen_prelude::Env, value: &V) -> napi_ohos::bindgen_prelude::Result<bool> {
          if let Some(ctor_ref) = napi_ohos::bindgen_prelude::get_class_constructor(#js_name_str) {
            let mut ctor = std::ptr::null_mut();
            napi_ohos::check_status!(
            ...
            let mut is_instance_of = false;
            napi_ohos::check_status!(
              unsafe { napi_ohos::sys::napi_instanceof(env.raw(), value.value().value, ctor, &mut is_instance_of) },
              "Failed to run instanceof for class `{}`",
              #js_name_str
            )?;
            Ok(is_instance_of)
          } else {
            Err(napi_ohos::Error::new(napi_ohos::Status::GenericFailure, format!("Failed to get constructor of class `{}`", #js_name_str)))
          }
        }
      }
    }
  ...
  fn gen_async_iterator_property(&self, class: &NapiClass, name: &Ident) -> TokenStream {
    ...
    quote! {
      napi_ohos::__private::create_async_iterator::<#name>(env, instance_value, wrapped_value);
    }
  }
  ...
  fn gen_to_napi_value_ctor_impl(&self, class: &NapiClass) -> TokenStream {
    ...
    for field in class.fields.iter() {
      ...
      match &field.name {
        ...
        syn::Member::Unnamed(i) => {
          ...
          field_conversions.push(
            quote! { <#ty as napi_ohos::bindgen_prelude::ToNapiValue>::to_napi_value(env, #arg_name)? },
          );
        }
      }
    }
    ...
    let finalize_trait = if class.use_custom_finalize {
      ...
      quote! { impl <'_javascript_function_scope> napi_ohos::bindgen_prelude::ObjectFinalize for #name<'_javascript_function_scope> {} }
    } else {
      quote! { impl napi_ohos::bindgen_prelude::ObjectFinalize for #name {} }
    };
  ...
  fn gen_to_napi_value_obj_impl(&self, obj: &NapiObject) -> TokenStream {
            ...
            if is_optional_field {
              ...
              value_conversions.push(quote! {
                let #value_var = if let Some(inner) = #alias_ident {
                  napi_ohos::bindgen_prelude::ToNapiValue::to_napi_value(env, inner)?
                } else {
                  napi_ohos::bindgen_prelude::ToNapiValue::to_napi_value(env, napi_ohos::bindgen_prelude::Null)?
                };
              });
            } else {
              // Non-optional: always set
              value_conversions.push(quote! {
                let #value_var = napi_ohos::bindgen_prelude::ToNapiValue::to_napi_value(env, #alias_ident)?;
              });
            }

            property_descriptors.push(quote! {
              napi_ohos::bindgen_prelude::sys::napi_property_descriptor {
                ...
                setter: None,
                value: #value_var,
                attributes: napi_ohos::bindgen_prelude::sys::PropertyAttributes::writable
                  | napi_ohos::bindgen_prelude::sys::PropertyAttributes::enumerable
                  | napi_ohos::bindgen_prelude::sys::PropertyAttributes::configurable,
        ...
        syn::Member::Unnamed(i) => {
          ...
          if is_always_set {
            ...
            if is_optional_field {
              ...
              // Non-optional: always set
              value_conversions.push(quote! {
                let #value_var = napi_ohos::bindgen_prelude::ToNapiValue::to_napi_value(env, #arg_name)?;
              });
            }
          ...
          if is_optional_field && !self.use_nullable {
            ...
            obj_field_getters.push(quote! {
              let #arg_name: #ty = obj.get(#field_js_name)?.ok_or_else(|| napi_ohos::bindgen_prelude::Error::new(
                napi_ohos::bindgen_prelude::Status::InvalidArg,
                format!("Missing field `{}`", #field_js_name),
              ))?;
            });
    ...
    let object_creation = if conditional_setters.is_empty() {
      ...
      quote! {
        ...
        let obj_ptr = napi_ohos::bindgen_prelude::create_object_with_properties(env, &properties)?;
        Ok(obj_ptr)
      }
    } else {
      ...
      quote! {
        ...
        let mut obj = napi_ohos::bindgen_prelude::Object::from_raw(env, obj_ptr);
  ...
  fn gen_register(&self, class: &NapiClass) -> TokenStream {
    ...
    if class.ctor {
      props.push(quote! { napi_ohos::bindgen_prelude::Property::new().with_utf8_name("constructor").unwrap().with_ctor(constructor) });
    }
    ...
    for field in class.fields.iter() {
      ...
      let mut prop = quote! {
        napi_ohos::bindgen_prelude::Property::new().with_utf8_name(#js_name)
          .unwrap()
  ...
  fn gen_to_napi_value_structured_enum_impl(
    ...
    for variant in structured_enum.variants.iter() {
      ...
      value_conversions.push(quote! {
        let #discriminant_value_var = napi_ohos::bindgen_prelude::ToNapiValue::to_napi_value(env, #variant_name_str)?;
      });
      property_descriptors.push(quote! {
        napi_ohos::bindgen_prelude::sys::napi_property_descriptor {
      ...
      let variant_object_creation = if conditional_setters.is_empty() {
        ...
        quote! {
          ...
          napi_ohos::bindgen_prelude::create_object_with_properties(env, &properties)
        }
      } else {
        ...
        impl napi_ohos::bindgen_prelude::FromNapiValue for #name {
          unsafe fn from_napi_value(
            ...
            let val = match type_.as_str() {
              #(#variant_arm_getters)*
              _ => return Err(napi_ohos::bindgen_prelude::Error::new(
                napi_ohos::bindgen_prelude::Status::InvalidArg,
  ...
  fn gen_helper_mod(&self) -> BindgenResult<TokenStream> {
    ...
    for item in self.items.iter() {
      ...
      let prop = props.entry(&item.js_name).or_insert_with(|| {
        quote! {
          napi_ohos::bindgen_prelude::Property::new().with_utf8_name(#js_name).unwrap().with_property_attributes(napi_ohos::bindgen_prelude::PropertyAttributes::from_bits(#attribute).unwrap())
        }
      });
