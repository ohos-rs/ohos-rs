  ...
  fn gen_to_napi_value_ctor_impl_for_non_default_constructor_struct(
    ...
    let (object_finalize_impl, to_napi_value_impl, javascript_class_ext_impl) = if self.has_lifetime
    {
      (
        ...
        quote! { impl <'_javascript_function_scope> napi_ohos::bindgen_prelude::JavaScriptClassExt for #name<'_javascript_function_scope> },
      )
    } else {
      (
    ...
    quote! {
      ...
      #javascript_class_ext_impl {
        fn into_instance<'scope>(self, env: &'scope napi_ohos::Env) -> napi_ohos::Result<napi_ohos::bindgen_prelude::ClassInstance<'scope, #name>> {
          if let Some(ctor_ref) = napi_ohos::bindgen_prelude::get_class_constructor(#js_name_str) {
            unsafe {
        ...
        fn into_reference(self, env: napi_ohos::Env) -> napi_ohos::Result<napi_ohos::bindgen_prelude::Reference<#name>> {
          if let Some(ctor_ref) = napi_ohos::bindgen_prelude::get_class_constructor(#js_name_str) {
            unsafe {
